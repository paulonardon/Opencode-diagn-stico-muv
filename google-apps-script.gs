...
const COLUMNS = [
  ...
  { header: 'Objetivo', key: 'objectiveLabel' },
  { header: 'Objetivo - valor', key: 'objectiveValue' },
  { header: 'Segmento', key: 'segmentLabel' },
  { header: 'Segmento - valor', key: 'segmentValue' },
  { header: 'Segmento - outro', key: 'segmentOther' },
  { header: 'Site', key: 'websiteUrl' },
  { header: 'Não tem site', key: 'noWebsite' },
  { header: 'Redes sociais', key: 'socialLinks' },
  { header: 'Não tem redes sociais', key: 'noSocialLinks' },
  { header: 'Oferta', key: 'offer' },
  { header: 'Ticket médio', key: 'ticketLabel' },
  { header: 'Ticket médio - valor', key: 'ticketValue' },
  { header: 'Como vende', key: 'salesModelLabel' },
  { header: 'Como vende - valor', key: 'salesModelValue' },
  ...
  { header: 'Tom de voz', key: 'toneLabel' },
  { header: 'Tom de voz - valor', key: 'toneValue' },
